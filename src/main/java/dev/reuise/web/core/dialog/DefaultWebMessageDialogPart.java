...
import dev.reuise.core.dialog.DefaultCoreMessageDialogPart;
...
public abstract class DefaultWebMessageDialogPart<S extends DefaultWebMessageDialogPart<S, O>, O extends WebMessageDialogPartOptions> extends DefaultCoreMessageDialogPart<S, O> implements WebComponentPart , WebMessageDialog {
    private WebDialogPart dialogPart;

    private WebParentComponentPart parentComponentPart;

    private WebBaseComponentPart baseComponentPart;

    protected DefaultWebMessageDialogPart(O options) {
        super(options);
    }

    protected void setupReferences() {
        // Parts
        dialogPart = getDialogPart();
    ...
    @Override
    public WebMessageDialog getComponent() {
        return ((WebMessageDialog) (baseComponentPart.getComponent()));
    }
    ...
    public void onInitialize(O options) {
        ...
        getDialogPart().getBody().addText(options.getText());
    }
