...
import dev.reuise.core.tabs.DefaultCoreTabPart;
...
public abstract class DefaultWebTabPart<S extends DefaultWebTabPart<S, O>, O extends WebTabPartOptions> extends DefaultCoreTabPart<S, O> implements WebTab , WebComponentPart {
    @Override
    ...
    protected DefaultWebTabPart(O options) {
        super(options);
    }
    ...
    public void setRootComponent(RootComponent rootComponent) {
        ...
        if (icon != null)
            icon.setRootComponent(rootComponent);
    ...
    @Override
    public WebTab getComponent() {
        return ((WebTab) (baseComponentPart.getComponent()));
    }
