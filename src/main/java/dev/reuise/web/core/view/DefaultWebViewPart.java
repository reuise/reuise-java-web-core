...
import dev.reuise.core.view.DefaultCoreViewPart;
...
public abstract class DefaultWebViewPart<S extends DefaultWebViewPart<S, O>, O extends WebViewPartOptions> extends DefaultCoreViewPart<S, O> implements WebView , WebComponentPart {
    ...
    protected DefaultWebViewPart(O options) {
        super(options);
    }
    ...
    public WebView getComponent() {
        return ((WebView) (baseComponentPart.getComponent()));
    }
    ...
    public void applyOptions(O options, OptionApplicator applicator, Collection<State> states) {
        ...
        WebViewPart component = ((WebViewPart) (options.getComponent()));
        if (component == null)
    ...
    public void onInitializeCommonStyle(StyleBuilder commonStyles) {
        commonStyles.addRule(".reuise-view").setWidth("inherit").setHeight("inherit");
    }
