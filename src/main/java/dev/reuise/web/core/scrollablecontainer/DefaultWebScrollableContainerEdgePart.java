...
import dev.reuise.core.scrollablecontainer.DefaultCoreScrollableContainerEdgePart;
...
public abstract class DefaultWebScrollableContainerEdgePart<S extends DefaultWebScrollableContainerEdgePart<S, O>, O extends WebScrollableContainerEdgePartOptions> extends DefaultCoreScrollableContainerEdgePart<S, O> implements WebScrollableContainerEdge , WebComponentPart {
    ...
    private void initScrollButton() {
        WebButtonOptions scrollButtonOpts = getBaseComponentPart().getComponentFactory().createButtonOptions();
        if (!isRehydrated())
            scrollButtonOpts.setBaseStyleClass("reuise-scrollablecontainer_edge_scrollbutton").setEnabled(false);
        else
    ...
    protected WebButton scrollButton;

    protected DefaultWebScrollableContainerEdgePart(O options) {
        super(options);
    }
    ...
    @Override
    public WebScrollableContainerEdge getComponent() {
        return ((WebScrollableContainerEdge) (baseComponentPart.getComponent()));
    }
    ...
    public void applyOptions(O options, OptionApplicator applicator, Collection<State> states) {
        ...
        WebScrollableContainerEdgePart component = ((WebScrollableContainerEdgePart) (options.getComponent()));
        if (component == null)
            System.out.println("component is null");

        // Apply options for default state
        applicator.add(options.getScrollButtonOption(), component::setScrollButton);
    }
