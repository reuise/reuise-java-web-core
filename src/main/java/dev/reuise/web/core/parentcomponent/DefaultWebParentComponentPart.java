...
import dev.reuise.core.parentcomponent.DefaultCoreParentComponentPart;
...
public abstract class DefaultWebParentComponentPart<S extends DefaultWebParentComponentPart<S, O>, O extends WebParentComponentPartOptions> extends DefaultCoreParentComponentPart<S, O> implements WebParentComponent , WebComponentPart {
    @Override
    public S addText(String text) {
        WebTextOptions textOpts = getBaseComponentPart().getComponentFactory().createTextOptions();
    ...
    protected DefaultWebParentComponentPart(O options) {
        super(options);
    }
    ...
    @Override
    public WebParentComponent getComponent() {
        return ((WebParentComponent) (baseComponentPart.getComponent()));
    }
