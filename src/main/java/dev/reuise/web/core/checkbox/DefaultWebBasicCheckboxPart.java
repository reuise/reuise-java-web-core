...
import dev.reuise.core.checkbox.DefaultCoreBasicCheckboxPart;
...
public abstract class DefaultWebBasicCheckboxPart<S extends DefaultWebBasicCheckboxPart<S, O>, O extends WebBasicCheckboxPartOptions> extends DefaultCoreBasicCheckboxPart<S, O> implements WebBasicCheckbox , WebComponentPart {
    @Override
    ...
    protected DefaultWebBasicCheckboxPart(O options) {
        super(options);
    }
    ...
    @Override
    public WebBasicCheckbox getComponent() {
        return ((WebBasicCheckbox) (baseComponentPart.getComponent()));
    }
    ...
    public void onInitializeCommonStyle(StyleBuilder commonStyles) {
        commonStyles.addRule("." + getBaseStyleClass()).setMargin(0);
        for (CheckboxSize s : CheckboxSize.values()) {
