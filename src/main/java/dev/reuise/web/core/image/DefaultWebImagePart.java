...
import dev.reuise.core.image.DefaultCoreImagePart;
import dev.reuise.core.image.SpriteOptions;
...
public abstract class DefaultWebImagePart<S extends DefaultWebImagePart<S, O>, O extends WebImagePartOptions> extends DefaultCoreImagePart<S, O> implements WebImage , WebComponentPart {
    @Override
    ...
    @Override
    public S setSpriteOptions(SpriteOptions spritOptions) {
        return self();
    }
    ...
    protected DefaultWebImagePart(O options) {
        super(options);
    }
    ...
    @Override
    public WebImage getComponent() {
        return ((WebImage) (baseComponentPart.getComponent()));
    }
    ...
    public void applyOptions(O options, OptionApplicator applicator, Collection<State> states) {
        ...
        WebImagePart component = ((WebImagePart) (options.getComponent()));
        if (component == null)
