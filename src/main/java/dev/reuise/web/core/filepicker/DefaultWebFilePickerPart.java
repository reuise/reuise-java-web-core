...
public abstract class DefaultWebFilePickerPart<S extends DefaultWebFilePickerPart<S, O>, O extends WebFilePickerPartOptions> implements WebFilePicker , WebComponentPart {
    @Override
    ...
    public S setMultiple(Boolean multiple) {
        setAttribute("multiple", Boolean.toString(multiple));
        return self();
    }

    private WebBaseComponentPart baseComponentPart;

    protected DefaultWebFilePickerPart(O options) {
    }
    ...
    @Override
    public WebFilePicker getComponent() {
        return ((WebFilePicker) (baseComponentPart.getComponent()));
    }
    ...
    public void applyOptions(O options, OptionApplicator applicator, Collection<State> states) {
        WebFilePickerPart component = ((WebFilePickerPart) (options.getComponent()));
        if (component == null)
            System.out.println("component is null");

        // Apply options for default state
        applicator.add(options.getAcceptOption(), component::setAccept);
        applicator.add(options.getMultipleOption(), component::setMultiple);
    }
