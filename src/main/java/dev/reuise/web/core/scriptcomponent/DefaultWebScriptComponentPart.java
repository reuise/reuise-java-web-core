...
public abstract class DefaultWebScriptComponentPart<S extends DefaultWebScriptComponentPart<S, O>, O extends WebScriptComponentPartOptions> implements WebScriptComponent , WebComponentPart {
    @Override
    ...
    public boolean isDefer() {
        return getAttribute("defer").equals("defer");
    }
    ...
    public boolean isAsync() {
        return getAttribute("async").equals("async");
    }
    ...
    protected DefaultWebScriptComponentPart(O options) {
    }
    ...
    @Override
    public WebScriptComponent getComponent() {
        return ((WebScriptComponent) (baseComponentPart.getComponent()));
    }
    ...
    public void applyOptions(O options, OptionApplicator applicator, Collection<State> states) {
        WebScriptComponentPart component = ((WebScriptComponentPart) (options.getComponent()));
        if (component == null)
        ...
        applicator.add(options.getCrossOriginOption(), component::setCrossOrigin);
        applicator.add(options.getAsyncOption(), component::setAsync);
        applicator.add(options.getDeferOption(), component::setDefer);
        applicator.add(options.getCodeOption(), component::setCode);
    }
