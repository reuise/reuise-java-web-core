...
import dev.reuise.core.button.DefaultCoreIconButtonPart;
...
public abstract class DefaultWebIconButtonPart<S extends DefaultWebIconButtonPart<S, O>, O extends WebIconButtonPartOptions> extends DefaultCoreIconButtonPart<S, O> implements WebComponentPart , WebIconButton {
    @Override
    ...
    protected DefaultWebIconButtonPart(O options) {
        super(options);
    }
    ...
    @Override
    public WebIconButton getComponent() {
        return ((WebIconButton) (baseComponentPart.getComponent()));
    }
    ...
    public void applyOptions(O options, OptionApplicator applicator, Collection<State> states) {
        ...
        WebIconButtonPart component = ((WebIconButtonPart) (options.getComponent()));
        if (component == null)
