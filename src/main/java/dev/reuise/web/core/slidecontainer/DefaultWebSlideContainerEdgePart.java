...
import dev.reuise.core.slidecontainer.DefaultCoreSlideContainerEdgePart;
...
public abstract class DefaultWebSlideContainerEdgePart<S extends DefaultWebSlideContainerEdgePart<S, O>, O extends WebSlideContainerEdgePartOptions> extends DefaultCoreSlideContainerEdgePart<S, O> implements WebSlideContainerEdge , WebComponentPart {
    ...
    private void initSlideButton() {
        WebButtonOptions slideButtonOpts = getBaseComponentPart().getComponentFactory().createButtonOptions();
        if (!isRehydrated())
            slideButtonOpts.setBaseStyleClass("reuise-slidecontainer_edge_slidebutton").setEnabled(false);
        else
    ...
    protected WebButton slideButton;

    protected DefaultWebSlideContainerEdgePart(O options) {
        super(options);
    }
    ...
    @Override
    public WebSlideContainerEdge getComponent() {
        return ((WebSlideContainerEdge) (baseComponentPart.getComponent()));
    }
    ...
    public void applyOptions(O options, OptionApplicator applicator, Collection<State> states) {
        ...
        WebSlideContainerEdgePart component = ((WebSlideContainerEdgePart) (options.getComponent()));
        if (component == null)
            System.out.println("component is null");

        // Apply options for default state
        applicator.add(options.getSlideButtonOption(), component::setSlideButton);
    }
