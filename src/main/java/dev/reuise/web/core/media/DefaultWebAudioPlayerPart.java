...
import dev.reuise.core.media.DefaultCoreAudioPlayerPart;
...
public abstract class DefaultWebAudioPlayerPart<S extends DefaultWebAudioPlayerPart<S, O>, O extends WebAudioPlayerPartOptions> extends DefaultCoreAudioPlayerPart<S, O> implements WebComponentPart , WebAudioPlayer {
    ...
    protected DefaultWebAudioPlayerPart(O options) {
        super(options);
    }
    ...
    @Override
    public WebAudioPlayer getComponent() {
        return ((WebAudioPlayer) (baseComponentPart.getComponent()));
    }
