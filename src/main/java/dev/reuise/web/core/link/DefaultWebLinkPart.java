...
import dev.reuise.core.link.DefaultCoreLinkPart;
...
public abstract class DefaultWebLinkPart<S extends DefaultWebLinkPart<S, O>, O extends WebLinkPartOptions> extends DefaultCoreLinkPart<S, O> implements WebLink , WebComponentPart {
    @Override
    ...
    protected DefaultWebLinkPart(O options) {
        super(options);
    }
    ...
    public S setTheme(Theme theme) {
        ...
        ComponentTheme globalTheme = theme.getButtonTheme();
        if (globalTheme != null) {
            ThemeColorSet accentColor = globalTheme.getAccentColor();
            if (accentColor != null) {
                for (Interaction interaction : Interaction.values()) {
                    getStyle(interaction).setColor(accentColor.getColor(interaction).toHex());
                }
            }
        }
    ...
    @Override
    public WebLink getComponent() {
        return ((WebLink) (baseComponentPart.getComponent()));
    }
    ...
    public void applyOptions(O options, OptionApplicator applicator, Collection<State> states) {
        ...
        WebLinkPart component = ((WebLinkPart) (options.getComponent()));
        if (component == null)
