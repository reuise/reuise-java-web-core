...
import dev.reuise.core.menu.DefaultCoreMenuItemPart;
...
public abstract class DefaultWebMenuItemPart<S extends DefaultWebMenuItemPart<S, O>, O extends WebMenuItemPartOptions> extends DefaultCoreMenuItemPart<S, O> implements WebMenuItem , WebComponentPart {
    ...
    protected DefaultWebMenuItemPart(O options) {
        super(options);
    }
    ...
    public WebMenuItem getComponent() {
        return ((WebMenuItem) (baseComponentPart.getComponent()));
    }
