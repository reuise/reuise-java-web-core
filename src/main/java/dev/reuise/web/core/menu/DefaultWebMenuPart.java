...
import dev.reuise.core.menu.DefaultCoreMenuPart;
...
public abstract class DefaultWebMenuPart<S extends DefaultWebMenuPart<S, O>, O extends WebMenuPartOptions> extends DefaultCoreMenuPart<S, O> implements WebMenu , WebComponentPart {
    @Override
    public void open() {
        addStyleClass("reuise-menu--opened");
    }

    @Override
    public void close() {
        removeStyleClass("reuise-menu--opened");
    }
    ...
    protected DefaultWebMenuPart(O options) {
        super(options);
    }
    ...
    public void setRootComponent(RootComponent rootComponent) {
        ...
        if (list != null)
            list.setRootComponent(rootComponent);
    ...
    @Override
    public WebMenu getComponent() {
        return ((WebMenu) (baseComponentPart.getComponent()));
    }
    ...
    @Override
    public WebListView getList() {
        return ((WebListView) (super.getList()));
    }
    ...
    public void onInitializeCommonStyle(StyleBuilder commonStyles) {
        ...
        commonStyles.addRule(".reuise-menuitem:disabled,.reuise-menuitem.reuise-disabled").setOpacity(0.3).setCursor("default").setPointerEvents("none");
        commonStyles.addRule(".reuise-menudivider").setBorderTop("1px solid rgba(0,0,0,.12)");
    }
