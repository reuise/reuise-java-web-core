...
import dev.reuise.core.applayout.DefaultCoreAppLayoutBodyPart;
...
public abstract class DefaultWebAppLayoutBodyPart<S extends DefaultWebAppLayoutBodyPart<S, O>, O extends WebAppLayoutBodyPartOptions> extends DefaultCoreAppLayoutBodyPart<S, O> implements WebComponentPart , WebAppLayoutBody {
    ...
    protected DefaultWebAppLayoutBodyPart(O options) {
        super(options);
    }
    ...
    @Override
    public WebAppLayoutBody getComponent() {
        return ((WebAppLayoutBody) (baseComponentPart.getComponent()));
    }
