...
public abstract class DefaultWebTextPart<S extends DefaultWebTextPart<S, O>, O extends WebTextPartOptions> extends DefaultCoreTextPart<S, O> implements WebText , WebComponentPart {
    ...
    @Override
    public WebText getComponent() {
        return ((WebText) (baseComponentPart.getComponent()));
    }
    ...
    public S setFontSize(Object fontSize, State state) {
        ...
        style.setFontSize(Style.parseProperty(fontSize));
        return self();
    }
    ...
    public S setLineHeight(Object lineHeight) {
        return setLineHeight(lineHeight, null);
    }
    ...
    public S setLineHeight(Object lineHeight, State state) {
        ...
        style.setLineHeight(Style.parseProperty(lineHeight));
        return self();
    }
