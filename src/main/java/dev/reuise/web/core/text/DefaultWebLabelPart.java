...
import dev.reuise.core.text.DefaultCoreLabelPart;
...
public abstract class DefaultWebLabelPart<S extends DefaultWebLabelPart<S, O>, O extends WebLabelPartOptions> extends DefaultCoreLabelPart<S, O> implements WebLabel , WebComponentPart {
    private WebInlineTextPart inlineTextPart;
    ...
    protected DefaultWebLabelPart(O options) {
        super(options);
    }

    protected void setupReferences() {
        // Parts
        inlineTextPart = getInlineTextPart();
    ...
    @Override
    public WebLabel getComponent() {
        return ((WebLabel) (baseComponentPart.getComponent()));
    }
