...
import dev.reuise.core.splitcontainer.DefaultCoreSplitContainerDividerPart;
...
public abstract class DefaultWebSplitContainerDividerPart<S extends DefaultWebSplitContainerDividerPart<S, O>, O extends WebSplitContainerDividerPartOptions> extends DefaultCoreSplitContainerDividerPart<S, O> implements WebComponentPart , WebSplitContainerDivider {
    ...
    protected DefaultWebSplitContainerDividerPart(O options) {
        super(options);
    }
    ...
    @Override
    public WebSplitContainerDivider getComponent() {
        return ((WebSplitContainerDivider) (baseComponentPart.getComponent()));
    }
    ...
    public S setThicknessAllStates(Integer thickness) {
        setThickness(ScreenSizeValues.of(thickness, thickness));
