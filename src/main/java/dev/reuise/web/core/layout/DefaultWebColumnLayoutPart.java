...
import dev.reuise.core.layout.DefaultCoreColumnLayoutPart;
...
public abstract class DefaultWebColumnLayoutPart<S extends DefaultWebColumnLayoutPart<S, O>, O extends WebColumnLayoutPartOptions> extends DefaultCoreColumnLayoutPart<S, O> implements WebColumnLayout , WebComponentPart {
    ...
    protected DefaultWebColumnLayoutPart(O options) {
        super(options);
    }
    ...
    @Override
    public WebColumnLayout getComponent() {
        return ((WebColumnLayout) (baseComponentPart.getComponent()));
    }
