...
import dev.reuise.core.layout.DefaultCoreFlexContainerPart;
...
public abstract class DefaultWebFlexContainerPart<S extends DefaultWebFlexContainerPart<S, O>, O extends WebFlexContainerPartOptions> extends DefaultCoreFlexContainerPart<S, O> implements WebFlexContainer , WebComponentPart {
    @Override
    ...
    public boolean isWrap(State state) {
        ...
        String wrapStyle = style.getFlexWrap();
        return (wrapStyle != null) && wrapStyle.equals("wrap");
    }

    @Override
    public S setWrap(Boolean wrap) {
        return setWrap(wrap, null);
    }
    ...
    public S setWrap(Boolean wrap, State state) {
        ...
        style.setFlexWrap(wrap ? "wrap" : "nowrap");
        return self();
    }
    ...
    public S setDirection(FlexDirection direction, State state) {
        ...
        style.setFlexDirection(direction.getCssValue());
        return self();
    }
    ...
    public S setJustifyContent(JustifyContent justifycontent) {
        return setJustifyContent(justifycontent, null);
    }
    ...
    public S setJustifyContent(JustifyContent justifycontent, State state) {
        ...
        style.setJustifyContent(justifycontent.getCssValue());
        return self();
    }

    @Override
    public S setAlignItems(AlignItems alignitems) {
        return setAlignItems(alignitems, null);
    }
    ...
    public S setAlignItems(AlignItems alignitems, State state) {
        ...
        style.setAlignItems(alignitems.getCssValue());
        return self();
    }
    ...
    public S setRowGap(Object rowGap, State state) {
        ...
        style.setRowGap(rowGap);
        return self();
    }

    @Override
    public S setColumnGap(Object rowGap, State state) {
        Style style = getStyle(state);
        if (style == null)
            return self();

        style.setColumnGap(rowGap);
        return self();
    }

    @Override
    public Object getGap(State state) {
        return getRowGap(state);
    }
    ...
    protected DefaultWebFlexContainerPart(O options) {
        super(options);
    }
    ...
    @Override
    public WebFlexContainer getComponent() {
        return ((WebFlexContainer) (baseComponentPart.getComponent()));
    }
    ...
    public void onInitializeCommonStyle(StyleBuilder commonStyles) {
        commonStyles.addRule(".reuise-flexcontainer").setDisplay("flex");
    }
