...
import dev.reuise.core.layout.DefaultCoreContainerPart;
...
public abstract class DefaultWebContainerPart<S extends DefaultWebContainerPart<S, O>, O extends WebContainerPartOptions> extends DefaultCoreContainerPart<S, O> implements WebComponentPart , WebContainer {
    @Override
    public BackdropFilterSetting getBackdropFilter() {
        return getBackdropFilter(null);
    }

    @Override
    public S setBackdropFilter(BackdropFilterSetting backdropFilter) {
        return setBackdropFilter(backdropFilter, null);
    }
    ...
    public S setBackdropFilter(BackdropFilterSetting backdropFilter, State state) {
        ...
        if (style != null)
            style.setBackdropFilter(backdropFilter.getCssValue());
    ...
    public BackdropFilterSetting getBackdropFilter(State state) {
        Style style = getStyle(state);
        String backdropFilterValue = style.getBackdropFilter();
        if ((backdropFilterValue != null) && (!backdropFilterValue.isEmpty()))
    ...
    protected DefaultWebContainerPart(O options) {
        super(options);
    }
    ...
    @Override
    public WebContainer getComponent() {
        return ((WebContainer) (baseComponentPart.getComponent()));
    }
    ...
    public S setPadding(Object padding) {
        return setPadding(padding, null);
    }
    ...
    public S setPadding(Object padding, State state) {
        ...
        style.setPadding(Style.parseProperty(padding));
        return self();
    }
    ...
    public S setPaddingTop(Object paddingTop) {
        return setPaddingTop(paddingTop, null);
    }
    ...
    public S setPaddingTop(Object paddingTop, State state) {
        ...
        style.setPaddingTop(Style.parseProperty(paddingTop));
        return self();
    }
    ...
    public S setPaddingRight(Object paddingRight) {
        return setPaddingRight(paddingRight, null);
    }
    ...
    public S setPaddingRight(Object paddingRight, State state) {
        ...
        style.setPaddingRight(Style.parseProperty(paddingRight));
        return self();
    }
    ...
    public S setPaddingBottom(Object paddingBottom) {
        return setPaddingBottom(paddingBottom, null);
    }
    ...
    public S setPaddingBottom(Object paddingBottom, State state) {
        ...
        style.setPaddingBottom(Style.parseProperty(paddingBottom));
        return self();
    }
    ...
    public S setPaddingLeft(Object paddingLeft) {
        return setPaddingLeft(paddingLeft, null);
    }
    ...
    public S setPaddingLeft(Object paddingLeft, State state) {
        ...
        style.setPaddingLeft(Style.parseProperty(paddingLeft));
        return self();
    }
    ...
    public S setPosition(String position, State state) {
        ...
        style.setPosition(Style.parseProperty(position));
        return self();
    }
    ...
    public Object getInset(State state) {
        ...
        return style.getInset();
    }

    @Override
    public S setInset(Object inset) {
        return setInset(inset, null);
    }
    ...
    public S setInset(Object inset, State state) {
        ...
        style.setInset(Style.parseProperty(inset));
        return self();
    }
