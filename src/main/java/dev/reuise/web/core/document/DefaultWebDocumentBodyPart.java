...
public abstract class DefaultWebDocumentBodyPart<S extends DefaultWebDocumentBodyPart<S, O>, O extends WebDocumentBodyPartOptions> implements WebDocumentBody , WebComponentPart {
    private WebParentComponentPart parentComponentPart;

    private WebBaseComponentPart baseComponentPart;

    protected DefaultWebDocumentBodyPart(O options) {
    }
    ...
    @Override
    public WebDocumentBody getComponent() {
        return ((WebDocumentBody) (baseComponentPart.getComponent()));
    }
