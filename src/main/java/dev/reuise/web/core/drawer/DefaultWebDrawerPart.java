...
import dev.reuise.core.drawer.DefaultCoreDrawerPart;
import dev.reuise.core.drawer.DrawerPosition;
...
public abstract class DefaultWebDrawerPart<S extends DefaultWebDrawerPart<S, O>, O extends WebDrawerPartOptions> extends DefaultCoreDrawerPart<S, O> implements WebDrawer , WebComponentPart {
    @Override
    ...
    @Override
    public S setDrawerPosition(DrawerPosition position, State state) {
        return self();
    }
    ...
    public S setTransitionDuration(Integer transitionDuration) {
        getStyle().setTransitionDuration(transitionDuration + "ms", true);
        return self();
    }

    @Override
    public void open() {
        addStyleClass(getBaseStyleClass() + "--opened");
    }

    @Override
    public boolean isOpen() {
        return hasStyleClass(getBaseStyleClass() + "--opened");
    }

    @Override
    public void close() {
        addStyleClass(getBaseStyleClass() + "--closing");
        removeStyleClass(getBaseStyleClass() + "--opened");
    }
    ...
    protected DefaultWebDrawerPart(O options) {
        super(options);
    }
    ...
    @Override
    public WebDrawer getComponent() {
        return ((WebDrawer) (baseComponentPart.getComponent()));
    }
    ...
    public S setDrawerPositionAllStates(DrawerPosition drawerPosition) {
        setDrawerPosition(ScreenSizeValues.of(drawerPosition, drawerPosition));
