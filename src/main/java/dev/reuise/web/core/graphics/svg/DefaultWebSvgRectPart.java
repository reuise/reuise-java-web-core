...
public abstract class DefaultWebSvgRectPart<S extends DefaultWebSvgRectPart<S, O>, O extends WebSvgRectPartOptions> implements WebComponentPart , WebSvgRect {
    ...
    protected DefaultWebSvgRectPart(O options) {
    }
    ...
    @Override
    public WebSvgRect getComponent() {
        return ((WebSvgRect) (baseComponentPart.getComponent()));
    }
