...
public abstract class DefaultWebSvgTextPart<S extends DefaultWebSvgTextPart<S, O>, O extends WebSvgTextPartOptions> implements WebComponentPart , WebSvgText {
    ...
    protected DefaultWebSvgTextPart(O options) {
    }
    ...
    @Override
    public WebSvgText getComponent() {
        return ((WebSvgText) (baseComponentPart.getComponent()));
    }
    ...
    public void applyOptions(O options, OptionApplicator applicator, Collection<State> states) {
        WebSvgTextPart component = ((WebSvgTextPart) (options.getComponent()));
        if (component == null)
