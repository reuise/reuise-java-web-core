...
public abstract class DefaultWebSvgGroupPart<S extends DefaultWebSvgGroupPart<S, O>, O extends WebSvgGroupPartOptions> implements WebSvgGroup , WebComponentPart {
    ...
    protected DefaultWebSvgGroupPart(O options) {
    }
    ...
    @Override
    public WebSvgGroup getComponent() {
        return ((WebSvgGroup) (baseComponentPart.getComponent()));
    }
