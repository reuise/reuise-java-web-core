...
public abstract class DefaultWebSvgImagePart<S extends DefaultWebSvgImagePart<S, O>, O extends WebSvgImagePartOptions> implements WebSvgImage , WebComponentPart {
    @Override
    ...
    public String getPreserveAspectRatio() {
        return getAttribute("preserveAspectRatio");
    }
    ...
    protected DefaultWebSvgImagePart(O options) {
    }
    ...
    @Override
    public WebSvgImage getComponent() {
        return ((WebSvgImage) (baseComponentPart.getComponent()));
    }
    ...
    public void applyOptions(O options, OptionApplicator applicator, Collection<State> states) {
        WebSvgImagePart component = ((WebSvgImagePart) (options.getComponent()));
        if (component == null)
            System.out.println("component is null");

        // Apply options for default state
        applicator.add(options.getHrefOption(), component::setHref);
        applicator.add(options.getPreserveAspectRatioOption(), component::setPreserveAspectRatio);
    }
