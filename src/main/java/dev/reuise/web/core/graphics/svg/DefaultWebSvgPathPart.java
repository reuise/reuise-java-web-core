...
public abstract class DefaultWebSvgPathPart<S extends DefaultWebSvgPathPart<S, O>, O extends WebSvgPathPartOptions> implements WebComponentPart , WebSvgPath {
    @Override
    ...
    private WebSvgShapePart svgShapePart;
    ...
    protected DefaultWebSvgPathPart(O options) {
    }

    protected void setupReferences() {
        // Parts
        svgShapePart = getSvgShapePart();
        svgPart = getSvgPart();
    ...
    public String getFill() {
        return svgShapePart.getFill();
    }

    @Override
    public S setFill(String fill) {
        this.svgShapePart.setFill(fill);
        return self();
    }

    @Override
    public String getStroke() {
        return svgShapePart.getStroke();
    }

    @Override
    public S setStroke(String stroke) {
        this.svgShapePart.setStroke(stroke);
        return self();
    }

    @Override
    public Double getStrokeWidth() {
        return svgShapePart.getStrokeWidth();
    }

    @Override
    public S setStrokeWidth(Double strokeWidth) {
        this.svgShapePart.setStrokeWidth(strokeWidth);
        return self();
    }
    ...
    @Override
    public WebSvgPath getComponent() {
        return ((WebSvgPath) (baseComponentPart.getComponent()));
    }
    ...
    public void applyOptions(O options, OptionApplicator applicator, Collection<State> states) {
        WebSvgPathPart component = ((WebSvgPathPart) (options.getComponent()));
        if (component == null)
