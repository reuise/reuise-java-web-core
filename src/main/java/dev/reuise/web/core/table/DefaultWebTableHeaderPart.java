...
import dev.reuise.core.table.DefaultCoreTableHeaderPart;
...
public abstract class DefaultWebTableHeaderPart<S extends DefaultWebTableHeaderPart<S, O>, O extends WebTableHeaderPartOptions> extends DefaultCoreTableHeaderPart<S, O> implements WebComponentPart , WebTableHeader {
    @Override
    public S setFixed(Boolean fixed) {
        addOrRemoveStyleClass(getBaseStyleClass() + "--fixed", fixed);
        return self();
    }

    @Override
    public boolean isFixed() {
        return hasStyleClass(getBaseStyleClass() + "--fixed");
    }
    ...
    protected DefaultWebTableHeaderPart(O options) {
        super(options);
    }
    ...
    public void setRootComponent(RootComponent rootComponent) {
        ...
        if (row != null)
            row.setRootComponent(rootComponent);
    ...
    @Override
    public WebTableHeader getComponent() {
        return ((WebTableHeader) (baseComponentPart.getComponent()));
    }
    ...
    @Override
    public WebTableHeaderRow getRow() {
        return ((WebTableHeaderRow) (super.getRow()));
    }
