...
import dev.reuise.core.table.DefaultCoreTableCellPart;
...
public abstract class DefaultWebTableCellPart<S extends DefaultWebTableCellPart<S, O>, O extends WebTableCellPartOptions> extends DefaultCoreTableCellPart<S, O> implements WebTableCell , WebComponentPart {
    private WebParentComponentPart parentComponentPart;

    private WebBaseComponentPart baseComponentPart;

    protected DefaultWebTableCellPart(O options) {
        super(options);
    }
    ...
    @Override
    public WebTableCell getComponent() {
        return ((WebTableCell) (baseComponentPart.getComponent()));
    }
