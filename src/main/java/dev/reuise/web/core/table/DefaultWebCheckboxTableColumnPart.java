...
import dev.reuise.core.table.DefaultCoreCheckboxTableColumnPart;
...
public abstract class DefaultWebCheckboxTableColumnPart<S extends DefaultWebCheckboxTableColumnPart<S, O>, O extends WebCheckboxTableColumnPartOptions> extends DefaultCoreCheckboxTableColumnPart<S, O> implements WebComponentPart , WebCheckboxTableColumn {
    private WebTableColumnPart tableColumnPart;

    private WebParentComponentPart parentComponentPart;

    private WebBaseComponentPart baseComponentPart;

    protected DefaultWebCheckboxTableColumnPart(O options) {
        super(options);
    }

    protected void setupReferences() {
        // Parts
        tableColumnPart = getTableColumnPart();
    ...
    @Override
    public WebCheckboxTableColumn getComponent() {
        return ((WebCheckboxTableColumn) (baseComponentPart.getComponent()));
    }
