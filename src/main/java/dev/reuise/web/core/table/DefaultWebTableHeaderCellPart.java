...
import dev.reuise.core.table.DefaultCoreTableHeaderCellPart;
...
public abstract class DefaultWebTableHeaderCellPart<S extends DefaultWebTableHeaderCellPart<S, O>, O extends WebTableHeaderCellPartOptions> extends DefaultCoreTableHeaderCellPart<S, O> implements WebComponentPart , WebTableHeaderCell {
    private WebParentComponentPart parentComponentPart;

    private WebBaseComponentPart baseComponentPart;

    protected DefaultWebTableHeaderCellPart(O options) {
        super(options);
    }
    ...
    public void setRootComponent(RootComponent rootComponent) {
        ...
        if (menuButton != null)
            menuButton.setRootComponent(rootComponent);
    ...
    @Override
    public WebTableHeaderCell getComponent() {
        return ((WebTableHeaderCell) (baseComponentPart.getComponent()));
    }
    ...
    public boolean onPreInitialize(O options) {
        ...
        if (!isRehydrated()) {
            WebIconButton menuButton = getMenuButton();
            if (menuButton == null)
                return true;

            WebIcon icon = menuButton.getIcon();
            if (icon == null)
                return true;

            WebSvg iconSvg = icon.getSvg();
            if (iconSvg != null) {
                WebSvgPathOptions svgPathOpts = getComponentFactory().createSvgPathOptions();
                svgPathOpts.setPath("M480-160q-33 0-56.5-23.5T400-240q0-33 23.5-56.5T480-320q33 0 56.5 23.5T560-240q0 33-23.5 56.5T480-160Zm0-240q-33 0-56.5-23.5T400-480q0-33 23.5-56.5T480-560q33 0 56.5 23.5T560-480q0 33-23.5 56.5T480-400Zm0-240q-33 0-56.5-23.5T400-720q0-33 23.5-56.5T480-800q33 0 56.5 23.5T560-720q0 33-23.5 56.5T480-640Z");
    ...
    @Override
    public WebIconButton getMenuButton() {
        return ((WebIconButton) (super.getMenuButton()));
    }
