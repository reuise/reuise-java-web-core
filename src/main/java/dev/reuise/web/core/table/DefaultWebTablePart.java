...
import dev.reuise.core.table.DefaultCoreTablePart;
...
public abstract class DefaultWebTablePart<S extends DefaultWebTablePart<S, O>, O extends WebTablePartOptions> extends DefaultCoreTablePart<S, O> implements WebTable , WebComponentPart {
    private WebParentComponentPart parentComponentPart;

    private WebBaseComponentPart baseComponentPart;

    protected DefaultWebTablePart(O options) {
        super(options);
    }
    ...
    @Override
    public WebTable getComponent() {
        return ((WebTable) (baseComponentPart.getComponent()));
    }
    ...
    @Override
    public WebContainer getTable() {
        return ((WebContainer) (super.getTable()));
    }

    @Override
    public WebTableColumnGroup getColumnGroup() {
        return ((WebTableColumnGroup) (super.getColumnGroup()));
    }

    @Override
    public WebTableHeader getHeader() {
        return ((WebTableHeader) (super.getHeader()));
    }

    @Override
    public WebTableBody getBody() {
        return ((WebTableBody) (super.getBody()));
    }

    @Override
    public WebTableFooter getFooter() {
        return ((WebTableFooter) (super.getFooter()));
    }

    // Implementation
    // Implementation
    public void onInitializeCommonStyle(StyleBuilder commonStyles) {
        commonStyles.addRule(".reuise-table").setOverflow("auto");
        commonStyles.addRule(".reuise-table_table").setWidth("inherit").setBorderCollapse("collapse");
        commonStyles.addRule(".reuise-table_row").setHeight(52);
        commonStyles.addRule(".reuise-table_cell").setPadding(16).setLineHeight(20);
        commonStyles.addRule(".reuise-table_header--fixed>tr").setPosition("sticky").setTop(0).setZIndex(1);
        commonStyles.addRule(".reuise-table_header>tr>th").setHeight(56).setPadding(0);
        commonStyles.addRule(".reuise-table_header>tr").setBackgroundColor("white");
    }
}