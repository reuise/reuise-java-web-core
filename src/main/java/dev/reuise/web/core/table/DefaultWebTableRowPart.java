...
import dev.reuise.core.table.DefaultCoreTableRowPart;
...
public abstract class DefaultWebTableRowPart<S extends DefaultWebTableRowPart<S, O>, O extends WebTableRowPartOptions> extends DefaultCoreTableRowPart<S, O> implements WebTableRow , WebComponentPart {
    private WebParentComponentPart parentComponentPart;

    private WebBaseComponentPart baseComponentPart;

    protected DefaultWebTableRowPart(O options) {
        super(options);
    }
    ...
    @Override
    public WebTableRow getComponent() {
        return ((WebTableRow) (baseComponentPart.getComponent()));
    }
