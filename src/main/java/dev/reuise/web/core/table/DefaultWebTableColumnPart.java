...
import dev.reuise.core.table.DefaultCoreTableColumnPart;
...
public abstract class DefaultWebTableColumnPart<S extends DefaultWebTableColumnPart<S, O>, O extends WebTableColumnPartOptions> extends DefaultCoreTableColumnPart<S, O> implements WebTableColumn , WebComponentPart {
    @Override
    ...
    public Object getWidth() {
        ...
        Object width = style.getMinWidth();
        return width instanceof Integer ? width : Integer.parseInt(((String) (width)));
    }
    ...
    protected DefaultWebTableColumnPart(O options) {
        super(options);
    }
    ...
    @Override
    public WebTableColumn getComponent() {
        return ((WebTableColumn) (baseComponentPart.getComponent()));
    }
