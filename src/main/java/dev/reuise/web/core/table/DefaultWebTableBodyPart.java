...
import dev.reuise.core.table.DefaultCoreTableBodyPart;
...
public abstract class DefaultWebTableBodyPart<S extends DefaultWebTableBodyPart<S, O>, O extends WebTableBodyPartOptions> extends DefaultCoreTableBodyPart<S, O> implements WebTableBody , WebComponentPart {
    private WebParentComponentPart parentComponentPart;

    private WebBaseComponentPart baseComponentPart;

    protected DefaultWebTableBodyPart(O options) {
        super(options);
    }
    ...
    @Override
    public WebTableBody getComponent() {
        return ((WebTableBody) (baseComponentPart.getComponent()));
    }
