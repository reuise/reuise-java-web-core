...
import dev.reuise.core.table.DefaultCoreCheckboxTableCellPart;
...
public abstract class DefaultWebCheckboxTableCellPart<S extends DefaultWebCheckboxTableCellPart<S, O>, O extends WebCheckboxTableCellPartOptions> extends DefaultCoreCheckboxTableCellPart<S, O> implements WebComponentPart , WebCheckboxTableCell {
    private WebTableCellPart tableCellPart;

    private WebParentComponentPart parentComponentPart;

    private WebBaseComponentPart baseComponentPart;

    protected DefaultWebCheckboxTableCellPart(O options) {
        super(options);
    }

    protected void setupReferences() {
        // Parts
        tableCellPart = getTableCellPart();
    ...
    @Override
    public WebCheckboxTableCell getComponent() {
        return ((WebCheckboxTableCell) (baseComponentPart.getComponent()));
    }
