...
import dev.reuise.core.table.DefaultCoreTableFooterPart;
...
public abstract class DefaultWebTableFooterPart<S extends DefaultWebTableFooterPart<S, O>, O extends WebTableFooterPartOptions> extends DefaultCoreTableFooterPart<S, O> implements WebComponentPart , WebTableFooter {
    @Override
    ...
    protected DefaultWebTableFooterPart(O options) {
        super(options);
    }
    ...
    @Override
    public WebTableFooter getComponent() {
        return ((WebTableFooter) (baseComponentPart.getComponent()));
    }
