...
import dev.reuise.core.bottomappbar.DefaultCoreBottomAppBarPart;
...
public abstract class DefaultWebBottomAppBarPart<S extends DefaultWebBottomAppBarPart<S, O>, O extends WebBottomAppBarPartOptions> extends DefaultCoreBottomAppBarPart<S, O> implements WebComponentPart , WebBottomAppBar {
    private WebBaseComponentPart baseComponentPart;

    protected DefaultWebBottomAppBarPart(O options) {
        super(options);
    }
    ...
    @Override
    public WebBottomAppBar getComponent() {
        return ((WebBottomAppBar) (baseComponentPart.getComponent()));
    }
