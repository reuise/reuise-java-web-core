...
import dev.reuise.core.list.DefaultCoreListItemPart;
...
public abstract class DefaultWebListItemPart<S extends DefaultWebListItemPart<S, O>, O extends WebListItemPartOptions> extends DefaultCoreListItemPart<S, O> implements WebListItem , WebComponentPart {
    @Override
    public S setToggleCheckboxOnClick(Boolean toggleCheckboxOnClick) {
        addOrRemoveStyleClass(getBaseStyleClass() + "--togglecheckboxonclick", toggleCheckboxOnClick);
        return self();
    }

    @Override
    public boolean isToggleCheckboxOnClick() {
        return hasStyleClass(getBaseStyleClass() + "--togglecheckboxonclick");
    }
    ...
    protected DefaultWebListItemPart(O options) {
        super(options);
    }
    ...
    @Override
    public WebListItem getComponent() {
        return ((WebListItem) (baseComponentPart.getComponent()));
    }
    ...
    public WebCheckbox getCheckbox() {
        return ((WebCheckbox) (super.getCheckbox()));
    }
    ...
    @Override
    public WebContainer getTextContainer() {
        return ((WebContainer) (super.getTextContainer()));
    }
    ...
    @Override
    public WebInlineText getSecondaryLabelContainer() {
        return ((WebInlineText) (super.getSecondaryLabelContainer()));
    }
