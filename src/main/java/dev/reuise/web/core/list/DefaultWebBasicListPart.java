...
import dev.reuise.core.list.DefaultCoreBasicListPart;
...
public abstract class DefaultWebBasicListPart<S extends DefaultWebBasicListPart<S, O>, O extends WebBasicListPartOptions> extends DefaultCoreBasicListPart<S, O> implements WebBasicList , WebComponentPart {
    private WebParentComponentPart parentComponentPart;

    private WebBaseComponentPart baseComponentPart;

    protected DefaultWebBasicListPart(O options) {
        super(options);
    }
    ...
    @Override
    public WebBasicList getComponent() {
        return ((WebBasicList) (baseComponentPart.getComponent()));
    }
    ...
    public void onInitializeCommonStyle(StyleBuilder commonStyles) {
        commonStyles.addRule(".reuise-basiclist");
        commonStyles.addRule(".reuise-basiclistitem_link").setCursor("pointer");
    }
