...
import dev.reuise.core.dropzone.DefaultCoreDropZonePart;
...
public abstract class DefaultWebDropZonePart<S extends DefaultWebDropZonePart<S, O>, O extends WebDropZonePartOptions> extends DefaultCoreDropZonePart<S, O> implements WebDropZone , WebComponentPart {
    private WebParentComponentPart parentComponentPart;

    private WebBaseComponentPart baseComponentPart;

    protected DefaultWebDropZonePart(O options) {
        super(options);
    }
    ...
    @Override
    public WebDropZone getComponent() {
        return ((WebDropZone) (baseComponentPart.getComponent()));
    }
